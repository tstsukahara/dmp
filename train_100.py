...
import visualize_100 as visualize
...
TRAIN_IMG_BASE_DIR = './images/train_100/' # 訓練データ格納ディレクトリ
...
def inference(x, keep_prob):
    ...
    W_conv1 = weight_variable([20, 20, COLOR_CHANNELS, 32], 'W_conv1')
    ...
    W_conv2 = weight_variable([20, 20, 32, 64], 'W_conv2')
